# The name of this view in Looker is "Duplicado Employee"
view: duplicado_employee {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `dataset_demo.duplicado_employee` ;;
  ...
  dimension: columa_nueva {
    type: string
    sql: ${TABLE}.columa_nueva ;;
  }
